---
title: "NuPoP: **Nu**cleosomes **Po**sitioning **P**rediction"
...
2. **A report of performance comparison of NuPoP (V2.0) vs nuCpos (V1.14) can be found at**
<https://github.com/jipingw/NuPoP_doc>

************************************

![\center{Figure: MNase_vs_Chemical}](snapshot_MNase_vs_Chemical.png)
********************
## About NuPoP
